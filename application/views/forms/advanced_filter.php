    ...
    <form id ="advanced-filter" method="get" accept-charset="UTF-8">
        ...
        <div id="advanced-filter-first-inputs">
            ...
            <?php foreach(Environment_vars::$maps['texts_to_id']['property_neighborhoods'] as $province => $neighborhoods):?>
                ...
                <?php $class = $i==0? 'advanced-filter-neigborhoods' : 'advanced-filter-neigborhoods hidden';?>
                ...
                <?php $neigborhoods_selects[] = Html_helper::get_select_from_key_value($neighborhoods, array("id" => "advanced-filter-neighborhood-for-province-".Environment_vars::$maps['texts_to_id']['provinces'][$province], "name" => $neighborhoods_input_name, "class" => $class, "data-province"=> Environment_vars::$maps['texts_to_id']['provinces'][$province]));?>
            
                <?php $i++;?>
            <?php endforeach;?>
            
            <label for="advanced-filter-province">Provincias:</label> 
        ...
        <p id="advanced-filter-footer">Copyright 2011 propiedom.com | Todos los derechos reservados.</p>
