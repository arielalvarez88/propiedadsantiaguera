...
<form enctype="multipart/form-data" id="signup-form" accept-charset="utf-8" method="post" action="<?php echo base_url(); ?>usuario/validate<?php echo  $edit ? '/edit' : ''; ?>">
    ...
    <div id="signup-info-text">
        ...
        <label class="company-agent-field agent-particular-field company-field <?php echo $hide_this_field_if_company_agent_is_editing_his_account;?>" for="signup-celular">Celular 1:</label> 
        <input class="company-agent-field agent-particular-field company-field <?php echo $hide_this_field_if_company_agent_is_editing_his_account;?>" <?php echo isset($cel) ? 'value="' . $cel . '"' : ''; ?> type="text" id="signup-celular" name="signup-cel"/>
        
        <label class="company-agent-field agent-particular-field company-field <?php echo $hide_this_field_if_company_agent_is_editing_his_account;?>" for="signup-celular">Celular 2:</label> 
        <input class="company-agent-field agent-particular-field company-field <?php echo $hide_this_field_if_company_agent_is_editing_his_account;?>" <?php echo isset($cel2) ? 'value="' . $cel2 . '"' : ''; ?> type="text" id="signup-celular" name="signup-cel2"/>
        ...
        <label class="agent-particular-field  company-field <?php echo $hide_this_field_if_company_agent_is_editing_his_account;?>" for="signup-desription">Descripci&oacute;n del usuario:</label> 
        <div>
            <textarea  class="agent-particular-field  company-field <?php echo $hide_this_field_if_company_agent_is_editing_his_account;?>" id="signup-descripcion" name="signup-description"><?php echo isset($description) ? $description : ''; ?></textarea> 
