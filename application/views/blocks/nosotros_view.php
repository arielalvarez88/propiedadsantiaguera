...
<ul>
<li>Completamente funcional, logrando maximizar el proceso de búsqueda y promoción de los inmubeles</li>
<li>Totalmente instructiva, ya que el público necesita orientación informativa en el área inmobiliaria</li>
    ...
    <tr>
        <td>
            ...
            <p>Con su lanzamiento en el 2012, Propiedad Santiaguera es una plataforma 
                virtual creada con el propósito de conectar a la comunidad de agentes 
                inmobiliarios con el<br> mercado nacional, de una manera fácil, interactiva 
                y colaborativa.</p>
        </td>
        <td>
            <img src="<?php base_url();?>/images/businessman.png" alt="business man"/>
        ...
        <td>
            ...
            <p>Con su lanzamiento en el 2012, Propiedad Santiaguera es una plataforma 
                virtual creada con el propósito de conectar a la comunidad de agentes 
                inmobiliarios con el mercado nacional, de una manera fácil, interactiva 
                y colaborativa.</p>
        </td>
        <td>
            <img src="<?php base_url();?>/images/businessman.png" alt="business man"/>
