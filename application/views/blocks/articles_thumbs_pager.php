        ...
        <ul>
            <?php foreach ($articles as $article): ?>
                <li>
                    ...
                    <img src="<?php echo $image_helper->resize($article->photo,72, 63, "/images/articlesPhotosThumbs/");?>" alt="articule_thumb"/>
                    <div class="articles-thumbs-pager-info">
                        <h2><img src="/images/common/smallGreenArrow.png" alt=""/><?php echo $article->title; ?></h2>
