        ...
        <div style="display:none;">
            <div id="login">
                ...
                <form action="/userController/login" method="post">
                    ...
                    <input id="login-password" type="password" name="login-password" class="login-input" /><br/>
                    <input id="login-submit" type="image" src="<?php echo base_url();?>images/login/loginButton.png" alt="login"/> <a href="#">&iquest;Olvido su contrase&ntilde;a?</a>
                </form>
            </div>
        </div>
