...
class Company_inscriber implements IUser_inscriber{
    ...
    {        
         ...
         return $this->inscriber_base_behavior->validate_info($user_info_getter,$inscriber_user_type);
    }
    
    public function validate_photos() {
        $this->inscriber_base_behavior->validate_photos();
    }
    ...
    public function save_address($user_object, $user_info_getter) {
                $this->inscriber_base_behavior->save_address($user_object, $user_info_getter);
    }

    public function save_cel($user_object, $user_info_getter) {
        $this->inscriber_base_behavior->save_cel($user_object, $user_info_getter);
    }
    ...
    public function save_description($user_object, $user_info_getter) {
        $this->inscriber_base_behavior->save_description($user_object, $user_info_getter);
    }

    public function save_email($user_object, $user_info_getter) {
        $this->inscriber_base_behavior->save_email($user_object, $user_info_getter);
    }

    public function save_fax($user_object, $user_info_getter) {
        $this->inscriber_base_behavior->save_fax($user_object, $user_info_getter);
    }
    ...
    public function save_password($user_object, $user_info_getter) {
        $this->inscriber_base_behavior->save_password($user_object, $user_info_getter);
    }

    public function save_photo($user_object, $user_info_getter) {
        $this->inscriber_base_behavior->save_photo($user_object, $user_info_getter);
    }

    public function save_rnc($user_object, $user_info_getter) {
        $this->inscriber_base_behavior->save_rnc($user_object, $user_info_getter);
    }

    public function save_tel($user_object, $user_info_getter) {
        $this->inscriber_base_behavior->save_tel($user_object, $user_info_getter);
    }

    public function save_website($user_object, $user_info_getter) {
        $this->inscriber_base_behavior->save_website($user_object, $user_info_getter);
    }

    public function save_type($user_object, $user_info_getter) {
        $this->inscriber_base_behavior->save_type($user_object, $user_info_getter);
    }
    
        public function save_inscription_date($user_object, $user_info_getter) {
         $this->inscriber_base_behavior->save_inscription_date($user_object, $user_info_getter);
     }
}
